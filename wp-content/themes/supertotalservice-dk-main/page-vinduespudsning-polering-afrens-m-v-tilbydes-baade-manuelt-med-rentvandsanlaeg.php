<?php
/*
Template Name: STS ApS | Vinduespudsning Polering Afrens M V Tilbydes Baade Manuelt Med Rentvandsanlaeg
*/
get_header(); ?>

<div class="page-vinduespudsning-polering-afrens-m-v-tilbydes-baade-manuelt-med-rentvandsanlaeg">
    <div class="page-content">
        <div class="section-hero"><section class="page-hero" id="hero" data-wpc-id="wpc_34dc454ab2" data-wpc-editable="section">
        <div class="container">
          <span class="eyebrow" data-wpc-id="wpc_eb4e8c97bc" data-wpc-editable="text">Vinduespudsning Polering Afrens M V Tilbydes Baade Manuelt Med Rentvandsanlaeg</span>
          <h1 data-wpc-id="wpc_8687c99a70" data-wpc-editable="heading">Vinduespudsning Polering Afrens M V Tilbydes Baade Manuelt Med Rentvandsanlaeg</h1>
...
<div class="grid-layout-container section-content"><section class="section" id="content" data-wpc-id="wpc_1afdb023ca" data-wpc-editable="section">
        <div class="container content-grid">
          ...
          <div class="hero-card">
            <img class="service-detail-main-image" src="<?php echo get_template_directory_uri(); ?>/assets/images/vinduespolering.jpg" alt="Vinduespolering" data-wpc-id="wpc_ecbfa9afb3" data-wpc-editable="image">
          </div>
        </div>
      </section></div>
...
<div class="section-cta"><section class="section" id="cta" data-wpc-id="wpc_7a7f000d96" data-wpc-editable="section">
        <div class="container form-card">
          ...
          <form data-wpconvert-form="needs-wiring" data-wpconvert-form-id="/vinduespudsning-polering-afrens-m-v-tilbydes-baade-manuelt-med-rentvandsanlaeg-form-0" action="" method="post">
